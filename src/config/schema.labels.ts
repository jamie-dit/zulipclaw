...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.delegationNudge.enabled": "Delegation Nudge",
  "tools.delegationNudge.softThreshold": "Delegation Soft Threshold",
  "tools.delegationNudge.hardThreshold": "Delegation Hard Threshold",
  "tools.delegationNudge.firstTurnHardThreshold": "Delegation First-turn Hard Threshold",
  "tools.delegationNudge.exemptTools": "Delegation Exempt Tools",
  ...
  "tools.webResearch.enabled": "Enable Web Research Tool",
  "tools.webResearch.defaultDepth": "Web Research Default Depth",
  "tools.webResearch.defaultModel": "Web Research Default Model",
  "tools.webResearch.quickModel": "Web Research Quick Model",
  "tools.webResearch.maxIterations.quick": "Web Research Quick Max Iterations",
  "tools.webResearch.maxIterations.standard": "Web Research Standard Max Iterations",
  "tools.webResearch.maxIterations.deep": "Web Research Deep Max Iterations",
  ...
  "agents.defaults.model.overloadFallback": "Overload Fallback Model",
